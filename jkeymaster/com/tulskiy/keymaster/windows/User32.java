...
public class User32 {
	...
	public static class Parameter extends IntegerType {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -4613707216534248266L;

		public Parameter() {
			this(0);
		}

		public Parameter(final long value) {
	...
	public static native boolean PeekMessage(MSG lpMsg, Pointer hWnd,
