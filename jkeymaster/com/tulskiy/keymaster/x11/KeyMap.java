...
import static com.tulskiy.keymaster.x11.KeySymDef.XK_PrintScreen;
...
public class KeyMap {
	...
	private static final HashMap<Integer, Integer> common = new HashMap<Integer, Integer>() {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -1200038328895741319L;

		{
			...
			put(VK_PRINTSCREEN, XK_PrintScreen);
	...
	public static byte getCode(final KeyStroke keyStroke, final Pointer display) {
		...
		if ((code >= VK_0 && code <= VK_9) || (code >= VK_A && code <= VK_Z)) {
			...
			final Integer i = common.get(code);
			if (i != null) {
				ret = i;
			}
		}
	...
	public static byte getMediaCode(final MediaKey mediaKey,
