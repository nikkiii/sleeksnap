...
public class KeyMap {
	...
	private static Map<Integer, Integer> codes = new HashMap<Integer, Integer>() {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 1141610439824232271L;
	...
	public static int getKeyCode(final KeyStroke keyStroke) {
		final Integer ret = codes.get(keyStroke.getKeyCode());
		if (ret != null) {
			return ret;
		} else {
			return -1;
	...
	public static int getModifier(final KeyStroke keyStroke) {
		int modifiers = 0;
